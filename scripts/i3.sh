...
# Install i3 tools
yay -S --noconfirm dmenu rofi slock dunst gsimplecal betterlockscreen xdotool feh maim arandr imagemagick
# Install theme things
yay -S --noconfirm nordic-polar-theme volantes-cursors papirus-icon-theme graphite-gtk-theme catppuccin-gtk-theme-macchiato
